...
import { Filter, ChevronDown, X, Check, Search, BadgeCheck, MapPin } from 'lucide-react';
...
const Catalog: React.FC = () => {
  ...
  const activeFiltersCount = (selectedCategory !== 'all' ? 1 : 0) + (priceRange.min ? 1 : 0) + (priceRange.max ? 1 : 0) + selectedConditions.length + (verifiedSellerOnly ? 1 : 0);
            ...
            <div className="mb-6 border-b border-gray-100 pb-6">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-gray-50 border border-gray-200 rounded-lg px-3 py-2 text-sm pl-9 outline-none focus:ring-2 focus:ring-teal-500 transition-all"
                />
